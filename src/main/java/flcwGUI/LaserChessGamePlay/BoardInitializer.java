...
public class BoardInitializer {
    ...
    public static Chess[][] initializeChess(int type){
        if(type==1){
            ...
            // 第零列
            chessboard[0][0] = new ChessLaserEmitter(ChessLaserEmitter.Direction.BOTTOM, ChessLaserEmitter.Color.RED);
            chessboard[2][0] = new ChessOneWayMirror(ChessOneWayMirror.Direction.RIGHT_TOP, ChessOneWayMirror.Color.RED);
            chessboard[3][0] = new ChessOneWayMirror(ChessOneWayMirror.Direction.RIGHT_BOTTOM, ChessOneWayMirror.Color.RED);


            //第二列
            chessboard[3][2] = new ChessTwoWayMirror(ChessTwoWayMirror.Direction.RIGHT_TOP, ChessTwoWayMirror.Color.RED);
            ...
            chessboard[2][4] = new ChessOneWayMirror(ChessOneWayMirror.Direction.LEFT_BOTTOM, ChessOneWayMirror.Color.RED);
            chessboard[3][4] = new ChessOneWayMirror(ChessOneWayMirror.Direction.LEFT_TOP, ChessOneWayMirror.Color.BLUE);
            chessboard[5][4] = new ChessShield(ChessShield.Direction.TOP, ChessShield.Color.BLUE);
            chessboard[6][4] = new ChessKing(ChessKing.Color.BLUE);
            chessboard[7][4] = new ChessShield(ChessShield.Direction.TOP, ChessShield.Color.BLUE);

            //第五列
            chessboard[0][5] = new ChessShield(ChessShield.Direction.BOTTOM, ChessShield.Color.RED);
            chessboard[1][5] = new ChessKing(ChessKing.Color.RED);
            chessboard[2][5] = new ChessShield(ChessShield.Direction.BOTTOM, ChessShield.Color.RED);
            chessboard[4][5] = new ChessOneWayMirror(ChessOneWayMirror.Direction.RIGHT_BOTTOM, ChessOneWayMirror.Color.RED);
            chessboard[5][5] = new ChessOneWayMirror(ChessOneWayMirror.Direction.RIGHT_TOP, ChessOneWayMirror.Color.BLUE);
            chessboard[7][5] = new ChessOneWayMirror(ChessOneWayMirror.Direction.RIGHT_TOP, ChessOneWayMirror.Color.BLUE);


            //第六列
            chessboard[0][6] = new ChessOneWayMirror(ChessOneWayMirror.Direction.RIGHT_BOTTOM, ChessOneWayMirror.Color.RED);
            chessboard[2][6] = new ChessTwoWayMirror(ChessTwoWayMirror.Direction.LEFT_TOP, ChessTwoWayMirror.Color.RED);
            chessboard[3][6] = new ChessOneWayMirror(ChessOneWayMirror.Direction.RIGHT_BOTTOM, ChessOneWayMirror.Color.BLUE);

            //第七列
            chessboard[4][7] = new ChessTwoWayMirror(ChessTwoWayMirror.Direction.RIGHT_TOP, ChessTwoWayMirror.Color.BLUE);


            //第九列
            chessboard[4][9] = new ChessOneWayMirror(ChessOneWayMirror.Direction.LEFT_TOP, ChessOneWayMirror.Color.BLUE);
            chessboard[5][9] = new ChessOneWayMirror(ChessOneWayMirror.Direction.LEFT_BOTTOM, ChessOneWayMirror.Color.BLUE);
            chessboard[7][9] = new ChessLaserEmitter(ChessLaserEmitter.Direction.TOP, ChessLaserEmitter.Color.BLUE);
